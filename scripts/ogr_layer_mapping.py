            ...
            if isinstance(model_field, GeometryField):
                ...
                if isinstance(ogr_name, dict):
                    ...
                    for rel_name, ogr_field in ogr_name.items():
                        ...
                        try:
                            rel_model._meta.get_field(rel_name.split("__")[0])  # noqa: SLF001
                        except FieldDoesNotExist as e:
                            error_msg = (
                                f"ForeignKey mapping field '{rel_name}' "
                                f"not in {rel_model.__class__.__name__} fields."
                            )
                            raise LayerMapError(error_msg) from e
    ...
    def verify_fk(self, feat, rel_model, rel_mapping):
        ...
        for field_name, ogr_name in rel_mapping.items():
            fk_kwargs[field_name] = self.verify_ogr_field(
                feat[ogr_name],
                rel_model._meta.get_field(field_name.split("__")[0]),  # noqa: SLF001
            )
        ...
        for field_name, ogr_name in self.mapping.items():
            ...
            if isinstance(model_field, GeometryField):
                ...
                try:
                    ...
                    raise LayerMapError(msg) from e
